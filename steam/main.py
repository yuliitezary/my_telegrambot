...
# Все, что тебе нужно:
token = "6028225386:AAGnM2iWr76I9fSkyRV4pRFJ1Gbi_bSsaalKXk" # токен основного бота
id = "7622139684" # Твой ид, что-бы бот кидал тебе все, что происходит в боте
site = "https://www.donationalerts.com/r/yuliitezary" # Cсылка оплаты(в конце ссылки пишите ваш ник QIWI)
channel = "https://t.me/joinchat/\" # Канал 
op = "Больше ботов на https://github.com/yuliitezary/my_telegrambot" # Аккаунт оператора
